from .info_set_generator import InfoSetGeneratorNetwork
...
from .discriminator_network import DiscriminatorNetwork
...
def create_network(game_name="tietactoe",
    ...
    if network_type_name == "alphazero":
        network = AlphaZeroNetwork(game_name,
                                   ...
                                   discrete_value_size)
    elif network_type_name == "siamese":
        network = SiameseNetwork(game_name,
                                 num_input_channels,
                                 input_channel_height,
                                 input_channel_width,
                                 num_hidden_channels,
        ...
        network = BinaryCNNNetwork(game_name,
                                   ...
                                   num_hidden_channels,
                                   num_blocks)
    elif network_type_name == "discriminator":
        network = DiscriminatorNetwork(game_name,
                                       num_input_channels,
                                       input_channel_height,
                                       input_channel_width,
                                       num_hidden_channels,
                                       ...
                                       num_value_hidden_channels,
                                       discrete_value_size)
    elif network_type_name == "info_set_generator":
        network = InfoSetGeneratorNetwork(game_name,
                                          num_input_channels,
                                          input_channel_height,
                                          input_channel_width,
                                          num_hidden_channels,
