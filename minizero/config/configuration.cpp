...
int iig_siamese_board_feature_channels = 4;
int iig_player_feature_channels = 6;
...
void setConfiguration(ConfigureLoader& cl)
{
    ...
    cl.addParameter("zero_current_iteration", zero_current_iteration, "the current iteration of training", "Zero");
    ...
    cl.addParameter("iig_siamese_board_feature_channels", iig_siamese_board_feature_channels, "the number of feature channels for the siamese network board input; only works when iig_nn_type_name is siamese", "IIG");
