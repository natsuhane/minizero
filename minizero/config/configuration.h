...
extern int zero_current_iteration;
...
// IIG parameters
extern std::string iig_nn_type_name;
extern std::string iig_nn_file_name;
extern std::string iig_generator_file_name;
extern std::string iig_discriminator_file_name;
extern std::string iig_player_file_name;
extern int iig_nn_feature_channels;
extern int iig_generator_feature_channels;
extern int iig_discriminator_feature_channels;
extern int iig_siamese_board_feature_channels;
extern int iig_player_feature_channels;
extern int iig_nn_embedding_size;
...
extern bool iig_generator_verification;
extern bool iig_generator_statistic;
extern std::string iig_generator_input_sgf;
extern std::string iig_generator_output_sgf;
extern float iig_generator_policy_threshold;
extern bool iig_use_discriminator;
extern std::string iig_discriminator_nn_type_name;
